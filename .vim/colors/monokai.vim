...
let s:background_color = "191919"

if exists("g:monokai_use_lowcolor_black") && g:monokai_use_lowcolor_black
...
fun! s:X(group, fg, bg, attr, lcfg, lcbg)
  ...
  if exists("g:monokai_use_term_italics") && g:monokai_use_term_italics
    let l:cterm_attr = l:attr
  else
    let l:cterm_attr = s:remove_italic_attr(l:attr)
  endif

  if !exists("g:monokai_use_gui_italics") || g:monokai_use_gui_italics
...
call s:X("Comment","74705d","","","yellow5","")
...
call s:X("Constant","ac80ff","","","Red","")
call s:X("Special","799d6a","","","Green","")
call s:X("Delimiter","668799","","","Grey","")

call s:X("String","e7db74","","","yellow","")
...
call s:X("NonText","15ff00",s:background_color,"",s:termBlack,"")
